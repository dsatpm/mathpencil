...
const KEYBOARD_ROWS: Array<{ keys: string; does: string }> = [
  ...
  { keys: "Backspace", does: "Rub out the last key press — sin( comes off in one." },
...
const FUNCTION_ROWS: Array<{ key: string; does: string }> = [
  ...
  {
    key: "n! mod",
    does: "Factorial — 5! is 120 — and, behind the shift, the remainder after a division: 17 mod 5 is 2.",
  },
  {
    key: "%",
